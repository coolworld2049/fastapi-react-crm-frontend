...
export const AuthApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        loginAccessToken: async (username: string, password: string, grantType?: string, scope?: string, clientId?: string, clientSecret?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v1/auth/jwt`;
...
export class AuthApi extends BaseAPI {
    ...
    public loginAccessToken(username: string, password: string, grantType?: string, scope?: string, clientId?: string, clientSecret?: string, options?: AxiosRequestConfig) {
        return AuthApiFp(this.configuration).loginAccessToken(username, password, grantType, scope, clientId, clientSecret, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const DatabaseApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Retrieve column_types.
         * @summary Read Column Types
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        readColumnTypes: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/column_types/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const DatabaseApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async readColumnTypes(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<object>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.readColumnTypes(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const DatabaseApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        readColumnTypes(options?: any): AxiosPromise<Array<object>> {
            return localVarFp.readColumnTypes(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class DatabaseApi extends BaseAPI {
     ...
     */
    public readColumnTypes(options?: AxiosRequestConfig) {
        return DatabaseApiFp(this.configuration).readColumnTypes(options).then((request) => request(this.axios, this.basePath));
    }
}
