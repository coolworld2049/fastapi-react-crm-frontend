...
import {TeacherCreate, TeacherEdit, TeacherList, TeacherTaskCreate} from "./pages/Menu/Teacher";
import {StudentTaskStoreEdit, StudentTaskStoreList} from "./pages/Menu/StudentTaskStore";
