import {
	...
	Create,
	Datagrid, DateField, List, ReferenceArrayInput,
	ReferenceField,
	ReferenceInput, ReferenceManyField, SelectArrayInput, SimpleShowLayout, SingleFieldList,
...
export const PanelStudyGroupTask = (props: any) => (
  <ReferenceManyField  source="id"
	    ...
	    <Datagrid bulkActionButtons={false} expand={PanelStudyGroupTaskTeacher} expandSingle>
...
export const PanelStudyGroupDisciplines = (props: any) => (
		<ListItem>
			<ReferenceManyField source="id"
		                      reference="study_groups"
		                      target="id"
			>
				<SingleFieldList sx={{ mr: 200}}>
					<ReferenceField reference={"disciplines"} source={"discipline_id"}
					                link="show"
					                label={"Discipline"}
					>
...
export const StudyGroupList = () => (
	<List>
		<Datagrid rowClick="edit" bulkActionButtons={false} expand={PanelStudyGroupDisciplines}>
