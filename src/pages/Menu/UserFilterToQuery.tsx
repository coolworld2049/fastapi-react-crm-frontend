...
export const filterToQueryStudent = (searchText: any) => ({
    email: `${searchText}`, role: ['student', 'student_leader', 'student_leader_assistant']
})


export const filterToQueryTeacher = (searchText: any) => ({
    email: `${searchText}`, role: 'teacher'
})
...
export const customOptionTextDiscipline = (record: { title: any; assessment: any; }) =>
  `${record.title}, ${record.assessment}`

export const customOptionTextStudyGroupCipher =
  (record: { id: any; }) => `${record.id}`


export const customOptionTextStudyGroup =
  (record: { study_group_cipher_id: any; discipline_id: any; }) =>
